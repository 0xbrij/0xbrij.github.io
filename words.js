...
"abate": {
    ...
    "trick": "Think of 'rebate' which means a discount or reduction.",
    "synonyms": ["decrease", "lessen", "diminish", "subside"],
    "examples": [
      "The storm finally began to abate after a night of heavy rain.",
      "The company's efforts to abate pollution were commendable.",
      "The pain in his leg abated after he took some medication.",
      "The public's fear abated once the vaccine became widely available.",
      "As the controversy abated, the politician regained popularity."
    ]
  },
  "belie": {
    "type": "verb",
  ...
  "daunt": {
    ...
    "trick": "Think of 'haunt' - something that haunts you can daunt you.",
    "synonyms": ["intimidate", "discourage", "unnerve", "dismay"],
    "examples": [
      "The size of the task didn't daunt him.",
      "Public speaking doesn't daunt her anymore.",
      "The challenges ahead daunted the new manager.",
      "The steep climb daunted many of the hikers.",
      "His confident attitude daunted his opponents."
    ]
  },
  "eclectic": {
    "type": "adjective",
  ...
  "garrulous": {
    ...
    "trick": "Think of 'Gary' - imagine a person named Gary who talks a lot.",
    "synonyms": ["talkative", "loquacious", "chatty", "voluble"],
    "examples": [
      ...
      "The meeting dragged on due to the garrulous participants.",
      "He became garrulous after a few drinks.",
      "Despite being garrulous, she was a good listener."
    ]
  },
  "hackneyed": {
    "type": "adjective",
    "meaning": "Lacking in freshness or originality; clichéd.",
    "trick": "Think of 'hacks' - hack writers produce hackneyed stories.",
    "synonyms": ["overused", "trite", "banal", "clichéd"],
    "examples": [
      "The hackneyed plot of the movie was predictable.",
      "She avoided using hackneyed phrases in her writing.",
      "The speech was full of hackneyed expressions.",
      "His hackneyed jokes failed to amuse the audience.",
      "The artist sought to break away from hackneyed styles."
    ]
  },
  "impetuous": {
    "type": "adjective",
  ...
  "nefarious": {
    ...
    "trick": "Think of 'nefarious' as 'not fair' - something wicked is not fair.",
    "synonyms": ["wicked", "evil", "sinister", "villainous"],
    "examples": [
      "The nefarious plot was uncovered by the detectives.",
      "He was involved in a nefarious scheme.",
      "The villain's nefarious deeds were well-known.",
      "The company was accused of nefarious activities.",
      "Her nefarious plans were thwarted by the hero."
    ]
  },
  "obfuscate": {
    "type": "verb",
    "meaning": "To render obscure, unclear, or unintelligible.",
    "trick": "Think of 'obscure' - to obfuscate is to obscure.",
    "synonyms": ["confuse", "muddle", "bewilder", "cloud"],
    "examples": [
      "The instructions were meant to clarify, but they only obfuscated the issue.",
      "The lawyer's convoluted arguments obfuscated the truth.",
      "He tried to obfuscate the facts to avoid blame.",
      "The jargon in the report obfuscated the key points.",
      "Her explanations only served to obfuscate rather than illuminate."
    ]
  },
  "paragon": {
    "type": "noun",
  ...
  "quixotic": {
    ...
    "trick": "Think of 'Don Quixote' - known for his unrealistic ideals.",
    "synonyms": ["idealistic", "impractical", "visionary", "romantic"],
    "examples": [
      "His quixotic plans were never realized.",
      "The quixotic nature of his proposal left many skeptical.",
      "She embarked on a quixotic journey to find her roots.",
      "His quixotic ideas often led to failure.",
      "The quixotic project was abandoned due to lack of funds."
    ]
  },
  "rescind": {
    "type": "verb",
  ...
  "sagacious": {
    ...
    "trick": "Think of 'sage' - a sagacious person is like a sage.",
    "synonyms": ["wise", "discerning", "shrewd", "insightful"],
    "examples": [
      "His sagacious advice helped steer the company through tough times.",
      "She was known for her sagacious decision-making.",
      "The sagacious leader was respected by all.",
      "His sagacious observations often led to innovative solutions.",
      "The judge's sagacious ruling was praised by legal experts."
    ]
  },
  "tantamount": {
    "type": "adjective",
  ...
  "yoke": {
    "type": "noun",
    "meaning": "A wooden crosspiece that is fastened over the necks of two animals and attached to the plow or cart that they are to pull; a symbol of burden or oppression.",
  ...
  "aberrant": {
    ...
    "trick": "Think of 'abnormal' - aberrant behavior is abnormal.",
    "synonyms": ["deviant", "atypical", "anomalous", "irregular"],
    "examples": [
      "His aberrant behavior raised suspicions.",
      "The results of the experiment were considered aberrant.",
      "The weather this year has been quite aberrant.",
      "Aberrant cells can sometimes indicate cancer.",
      "The artist's style was seen as aberrant by his contemporaries."
    ]
  },
  "burnish": {
    "type": "verb",
